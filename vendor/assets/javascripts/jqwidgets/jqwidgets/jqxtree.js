(function(a){
    ...
    a.extend(a.jqx._jqxTree.prototype,{
        ...
        ,createInstance:function(c){
            ...
            if(this.host.jqxDragDrop){jqxTreeDragDrop()}
        ...
        ,checkItems:function(f,h){
            ...
            if(f!=null){
                ...
                if(f!=h){
                    ...
                    a.each(j,function(){
                        var k=e.itemMapping["id"+this.id].item;e.checkItem(this,c)
                    })
                }
        ...
        ,_parseItem:function(l){
            ...
            var j=l.label;
            if(!l.label&&l.html){j=l.html}
            if(!j){j="Item"}
            if(typeof l==="string"){j=l}
            var g=false;
            if(l.expanded!=undefined&&l.expanded){g=true}
            var e=false;
            if(l.locked!=undefined&&l.locked){e=true}
            var c=false;
            if(l.selected!=undefined&&l.selected){c=true}
            var d=false;
            if(l.disabled!=undefined&&l.disabled){d=true}
            var k=false;
            if(l.checked!=undefined&&l.checked){k=true}
            var h=l.icon;
            var b=l.iconsize;
            f+="<li";
            if(g){f+=' item-expanded="true" '}
            if(e){f+=' item-locked="true" '}
            if(d){f+=' item-disabled="true" '}
            if(c){f+=' item-selected="true" '}
            if(b){f+=' item-iconsize="'+l.iconsize+'" '}
            if(l.leaf){f+=' item-leaf="'+l.leaf+'" '}            
            if(h!=null&&h!=undefined){f+=' item-icon="'+h+'" '}
            if(l.label&&!l.html){f+=' item-label="'+j+'" '}
            if(l.value!=null){f+=' item-value="'+l.value+'" '}
            if(l.checked!=undefined){f+=' item-checked="'+k+'" '}
            if(l.id!=undefined){
                f+=' id="'+l.id+'" '
            }else{
                f+=' id="'+this.createID()+'" '
            ...
            f+=">"+j;
            if(l.items){f+=this.loadItems(l.items)}
            f+="</li>";
            return f
        }
                    ...
                    if(g>=c&&g<c+h){
                        if(this.top+5<f&&f<this.top+this.height){
                            ...
                            if(j.length>0){
                                e=b.getItem(j[0]);
                                if(e!=null){
                                    e.height=this.height;e.top=this.top;
                                    return false
                                }
                            }
                        }
        ...
        ,addTo:function(n,p,m){
            ...
            if(p==undefined&&p==null){h.append(b)}
                ...
                if(d.length==0){
                    ulElement=a("<ul></ul>");
                    a(p).append(ulElement);
                    d=p.find("ul:first");
                    var q=k.itemMapping["id"+p[0].id].item;
                    q.subtreeElement=d[0];
                    q.hasItems=true;
        ...
        ,removeItem:function(b,c){
            ...
            var d=this;
            var e=b.id;
            if(this.host.find("#"+b.id).length>0){a(b).remove()}
            if(c==false){this._raiseEvent("5");return}
            ...
            this._raiseEvent("5");if(this.allowDrag&&this._enableDragDrop){this._enableDragDrop()}
        }
        ,clear:function(){
            this.items=new Array();
            this.itemMapping=new Array();
            var b=this.host.find("ul:first");
            if(b.length>0){b[0].innerHTML=""}
            this.selectedItem=null
        }
        ...
        ,isExpanded:function(b){
            ...
            var c=this.itemMapping["id"+b.id].item;if(c!=null){return c.isExpanded}
            return false
        }
        ,isSelected:function(b){
            if(b==null||b==undefined){return false}
            var c=this.itemMapping["id"+b.id].item;
            if(c!=null){return c==this.selectedItem}
            return false
        }
        ...
        ,_initialize:function(e,b){
            ...
            a.each(this.items,function(){
                ...
                l.arrow=j[0];
                if(!l.hasItems){j.css("visibility","hidden")}
        ...
        ,_render:function(e){
            if(a.browser.msie&&a.browser.version<8){
                ...
                a.each(this.items,function(){
                    ...
                    if(n<parseInt(m.css("min-width"))){o.css("min-width",k)}
            ...
            if(this.host.jqxPanel){
                ...
                var g="fixed";
                if(this.height==null||this.height=="auto"){g="verticalwrap"}
        ...
        ,_updateItemEvents:function(g,f){
            ...
            g.addHandler(a(f.checkBoxElement),b,function(j){
                ...
                if(g.hasThreeStates){g.checkItems(this.treeItem,this.treeItem)}
                return false
            });
            ...
            if(a.browser.opera){
                ...
                g.addHandler(a(f.titleElement),"mousedown",function(j){return false})
            }
            ...
            g.addHandler(a(f.titleElement),g.toggleMode,function(j){
                if(d.length>0){clearTimeout(d.data("timer").hide)}
                if(g.panel!=null){g.panel.jqxPanel({focused:true})}
                g.selectItem(f.element);
                if(f.isExpanding==undefined){f.isExpanding=false}
                if(f.isCollapsing==undefined){f.isCollapsing=false}
        ...
        ,_updateCheckState:function(e){
            ...
            a.each(g,function(h){
                ...
                if(j.checked!=false){
                    if(j.checked==null){f=true}
                    c++
                }
            });
            if(b>0){
                if(c==b){this.checkItem(e.element,true)}
                else{
                    if(c>0){
        ...
        ,_updateItemsNavigation:function(){
            ...
            for(i=0;i<e.length;i++){
                ...
                if(this.itemMapping["id"+b.id]){
                    ...
                    d.prevItem=null;
                    d.nextItem=null;
                    if(i>0){if(this.itemMapping["id"+e[i-1].id]){
        ...
        ,_createItem:function(c){
            ...
            var q=c.id;if(!q){q=this.createID()}
            var C=c;
            var m=a(c);
            C.id=q;
            ...
            if(g==undefined){g=new Array()}
                ...
                if(!h||!B){
                    if(a(C.firstChild).length>0){
                        if(z.icon){
                            var s=z.iconsize;
                            if(!s){s=16}
                            var A=a('<img width="'+s+'" height="'+s+'"  class="itemicon" src="'+z.icon+'"/>');
                            a(C).prepend(A);
                            A.css("margin-right","4px")
                        }
                        var b=C.innerHTML.indexOf("<ul");
                        if(b==-1){b=C.innerHTML.indexOf("<UL")}
                        if(b==-1){
                        ...
                        z.originalTitle="Item";
                        a(C).append(a("<span>Item</span>"));
                ...
                if(this.allowDrag){w.addClass("draggable")}
                if(l==null||l==undefined){l=z.titleElement;z.label=a.trim(w.text())}
                else{z.label=l}
            ...
            if(d){this.disableItem(z.element)}
            if(r){this.selectItem(z.element)}
            if(a.browser.msie&&a.browser.version<8){
                a(C).css("margin","0px");
                a(C).css("padding","0px")
            }
        ...
        ,propertyChangedHandler:function(d,l,b,j){
            ...
            if(l=="source"){
                if(this.source!=null){
                    ...
                    else{d.panel.jqxPanel("setcontent",f);d.host.css("border","none")}
                    var e=d.disabled;
